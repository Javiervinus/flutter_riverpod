...
class _$AuthStateTearOff {
  ...
  _AuthStateData data({required MasterModel master}) {
...
mixin _$AuthState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(MasterModel master) data,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(MasterModel master)? data,
...
class _$_AuthStateData implements _AuthStateData {
  const _$_AuthStateData({required this.master});
  ...
  @override
  String toString() {
    return 'AuthState.data(master: $master)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _AuthStateData &&
            (identical(other.master, master) ||
                const DeepCollectionEquality().equals(other.master, master)));
  }

  @override
  int get hashCode =>
      runtimeType.hashCode ^ const DeepCollectionEquality().hash(master);
...
abstract class _AuthStateData implements AuthState {
  const factory _AuthStateData({required MasterModel master}) =
      _$_AuthStateData;
